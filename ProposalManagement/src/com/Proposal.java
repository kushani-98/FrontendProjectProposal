...
public class Proposal {
	public Connection connect() {
		...
		try {
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/paffrontend", "root", "kushani1998#");
		...
		try
		{
			...
			output = "<table border=\"1\"><tr><th>ProposalName</th><th>ResearcherName</th> "+" <th>Catagory</th> "+"<th>Duration</th> "+" <th>Email</th> "+" <th>Phone</th> "+" <th>Budget</th> "+" <th>Userid</th> "+" <th>Summery</th>"+"<th>Status</th>"+"<th>Update</th>"+"<th>Remove</th></tr>";
